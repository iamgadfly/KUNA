    ...
    <div class="money__way">
      <div class="money__body">
        <div class="money__body-title">
          ...
          <li class="actived" data-content="uah">UAH</li>
          <li data-open-block="rub">RUB</li>
          <li data-open-block="btc">BTC</li>
          <li data-open-block="usdc">USDC</li>
        ...
        <div class="money__content">
          <div class="main__body">
            ...
            <div class="body__price">
              <div class="price__text-bold active" data-content="uah">1 246 244</div>
              <div class="price__text" data-content="rub">3 336 748.94</div>
              <div class="price__text"  data-content="btc">46 336.37 </div>
              <div class="price__text"  data-content="usdc">46 958.37 </div>


              <div class="price__text"  data-content="usdc">~$46 629.58</div>
            </div>
            <div class="body__change">
              <div class="change__text">4.31%</div>
            </div>
          ...
          <div class="main__body">
            ...
            <div class="body__volume">
              <div class="price__text-bold active ">8.59 BTC</div>
              <div class="price__text-rub">3 336 748.94</div>

              <div class="price__text">~$398.1K</div>
            </div>
          </div>
          <div class="main__body">
            <div class="main__body-icon">
          ...
          <div class="main__body">
            ...
            <div class="body__volume">
              <div class="price__text-bold">8.59 BTC</div>
              <div class="price__text">~$398.1K</div>
            </div>
          </div>
          <div class="main__body">
            <div class="main__body-icon">
              ...
              <div class="body__value">
                <img src="img/btc.svg" />
                <div class="body__text">
                  <a class="text__bold">BTC/</a><a cclass="ui" href="#">UAH</a>
                </div>
              </div>
            </div>
            <div class="body__price">
